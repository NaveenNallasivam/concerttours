...
public class HTMLSanitizerTest extends HybrisJUnit4TransactionalTest
{
	...
	@Test
	public void testValidateUrlScheme()
	{
		assertTrue(HTMLSanitizer.validateUrlScheme("<script>alert(\"Hello\")</script>"));
		assertTrue(HTMLSanitizer.validateUrlScheme("https://foo.bar/test"));
		assertTrue(HTMLSanitizer.validateUrlScheme("http://foo.bar/test"));
		assertTrue(HTMLSanitizer.validateUrlScheme("mailto://foo@bar.com"));
		assertTrue(HTMLSanitizer.validateUrlScheme("//foo.bar/test"));
		assertTrue(HTMLSanitizer.validateUrlScheme("/foo/bar/test"));
		assertTrue(HTMLSanitizer.validateUrlScheme("foo/bar/test"));
		assertTrue(HTMLSanitizer.validateUrlScheme("foo/javascript:/bar/test"));
		assertTrue(HTMLSanitizer.validateUrlScheme("javascript/foo/bar/test"));

		assertFalse(HTMLSanitizer.validateUrlScheme("data:test"));
		assertFalse(HTMLSanitizer.validateUrlScheme("ftps://foo.bar/test"));
		assertFalse(HTMLSanitizer.validateUrlScheme("javascript:test"));
	}
}
