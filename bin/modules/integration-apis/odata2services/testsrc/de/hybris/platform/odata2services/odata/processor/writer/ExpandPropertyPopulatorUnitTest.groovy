...
class ExpandPropertyPopulatorUnitTest extends Specification {
    ...
    def expandPopulator = new ExpandPropertyPopulator(permissionService: permissionService)
    ...
    @Test
    def "expand unit property when permissionService is null"() {
        given:
    ...
    def "expand with special localizedAttributes property does not validate"() {
        ...
        0 * permissionService.checkReadPermission("localizedAttributes")
    }
    ...
    def "expand unit property"() {
        ...
        1 * permissionService.checkReadPermission("Unit")
    }
    ...
    def "expand nested property"() {
        ...
        1 * permissionService.checkReadPermission("Catalog")
        1 * permissionService.checkReadPermission("CatalogVersion")
    }
