...
describe('componentCloneInfoForm', function() {
    ...
    var mocks, resource, controller, $q, $rootScope, systemEventService;
    ...
    beforeEach(function() {
        ...
        var harness = AngularUnitTestHelper.prepareModule('componentCloneInfoFormModule')
            .mock('catalogService', 'isUriContextEqualToCatalogVersion')
            .and.returnValue(resource)
            .mock('languageService', 'getLanguagesForSite')
            .and.returnValue(resource)
            .mock('pageFacade', 'contentPageWithLabelExists')
            .and.returnValue(resource)
