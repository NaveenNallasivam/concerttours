...
describe('sync service  - unit test', () => {
    ...
    it('should update sync status ', async (done) => {
    ...
    it('should get catalog sync status', async (done) => {
    ...
    it('should stop calling "get sync update" on authentication failure', async (done) => {
        // GIVEN
        const callback = jasmine.createSpy('callback');
    ...
    it('should continue calling "get sync update" on authentication success', async (done) => {
        const callback = jasmine.createSpy('callback').and.returnValue(Promise.reject());
    ...
    it('updateCatalogSync should mark that synchronization is in progress', async (done) => {
        // GIVEN
    ...
    it('GIVEN synchronization is in progress WHEN stopAutoGetSyncData is called THEN should only mark the timer as discardWhenNextSynced = true and the timer should not be stopped', async (done) => {
        // GIVEN
        const callback = jasmine.createSpy('callback');
    ...
    it('GIVEN synchronization is in progress WHEN synchronization is finished THEN it sends SYNCHRONIZATION_EVENT.CATALOG_SYNCHRONIZED event AND removes job from "synchronization requested" array', async (done) => {
        // GIVEN
    ...
    it('GIVEN synchronization is in progress WHEN synchronization is finished AND the job should be discarded THEN the timer is stopped AND the job is removed from "synchronization requested" array', async (done) => {
        // GIVEN
        const callback = jasmine.createSpy('callback').and.returnValue(Promise.resolve());
        const removeCatalogSyncRequest = spyOn(
            synchronizationService as any,
    ...
    it('GIVEN synchronization is in progress WHEN synchronization is aborted THEN the timer is stopped AND the job is removed from "synchronization requested" array', async (done) => {
        // GIVEN
        const callback = jasmine.createSpy('callback').and.returnValue(Promise.resolve());
        const removeCatalogSyncRequest = spyOn(
            synchronizationService as any,
