...
describe('Page Service ->', () => {
    ...
    describe('getPrimaryPagesForPageType', () => {
        ...
        it('WHEN getPrimaryPagesForPageType is called THEN it returns the list of primary pages for the given page type', async (done) => {
            // WHEN
            const value = await pageService.getPrimaryPagesForPageType(PAGE_TYPE, URI_CONTEXT);
