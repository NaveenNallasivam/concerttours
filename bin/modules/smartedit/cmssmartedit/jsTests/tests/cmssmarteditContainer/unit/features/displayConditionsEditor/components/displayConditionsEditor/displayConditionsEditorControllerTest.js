...
describe('displayConditionsEditorController', function() {
    ...
    beforeEach(function() {
        var harness = AngularUnitTestHelper.prepareModule('displayConditionsEditorModule')
            ...
            .mock('pageService', 'isPagePrimaryWithContext')
            .and.returnResolvedPromise(true)
            .mock('pageService', 'buildUriContextForCurrentPage')
            .and.returnResolvedPromise({
                CONTEXT_SITE_ID: 'CONTEXT_SITE_ID',
                CONTEXT_CATALOG: 'CONTEXT_CATALOG',
                CONTEXT_CATALOG_VERSION: 'CONTEXT_CATALOG_VERSION'
            })
            .mock('homepageService', 'hasFallbackHomePage')
            .and.returnResolvedPromise(true)
            .mock('homepageService', 'getHomepageDetailsForContext')
            .and.returnResolvedPromise(true)
        ...
        mocks.displayConditionsEditorModel.primaryPages = [
            'somePrimaryPage',
            'someOtherPrimaryPage'
        ];
    });
