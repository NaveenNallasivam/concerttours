...
describe('displayConditionsEditorModel', () => {
    ...
    beforeEach(() => {
        displayConditionsFacade = jasmine.createSpyObj('displayConditionsFacade', [
            ...
            'getPrimaryPagesForVariationPageType',
    ...
    describe('_initModelForVariation', () => {
        beforeEach(() => {
            ...
            displayConditionsFacade.getPrimaryPagesForVariationPageType.and.returnValue(
        ...
        it('should put the primary pages on the model scope if the page is a content page', () => {
            service.pageType = 'ContentPage';

            (service as any)._initModelForVariation('somePageUid').then(() => {
                expect(service.primaryPages).toEqual(
                    MOCK_PRIMARY_PAGES as IDisplayConditionsPrimaryPage[]
                );
            });
        });

        it('should not put the primary pages on the model scope if the page is a content page', () => {
