...
describe('addPageWizardController', function() {
    ...
    beforeEach(function() {
        ...
        var harness = AngularUnitTestHelper.prepareModule('addPageServiceModule')
            ...
            .and.returnResolvedPromise('TE_LANGUAGE')
            .mock('pageTemplateService', 'getPageTemplatesForType')
            .mock('addPageWizardService', 'getPageTypeFields')
            .and.returnResolvedPromise(true)
            .mock('experienceService', 'updateExperiencePageId')
            .mock('pageTypeService', 'getPageTypes')
            .and.returnResolvedPromise(MOCK_PAGE_TYPES)
            .mock('pageService', 'getPrimaryPagesForPageType')
            .and.returnResolvedPromise([])
            .mock('restrictionsStepHandlerFactory', 'createRestrictionsStepHandler')
            .and.returnValue(restrictionsStepHandler)
            .mock('wizardManager')
