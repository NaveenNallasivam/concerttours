...
module.exports = (function() {
    ...
    pageObject.elements = {
        ...
        getPage1PrimaryPageOption: function() {
            return by.xpath(
                "//label[contains(., 'Primary page associated to the variation')]/following-sibling::div[contains(., 'Homepage_uk_online')]"
            );
        },
        ...
        getProductPage1PrimaryPageOption: function() {
            return by.xpath(
                "//div[@id='page-condition-primary-selector-id']//div[contains(., 'productPage1')]"
            );
        },
