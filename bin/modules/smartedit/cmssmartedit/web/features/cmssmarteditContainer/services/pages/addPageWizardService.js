...
(function() {
    ...
    angular
            ...
            function PageBuilder(restrictionsStepHandler, uriContext) {
                    ...
                    if (page.defaultPage !== undefined) {
                        if (model.pageType) {
                            contextAwarePageStructureService
                                .getPageStructureForNewPage(model.pageType.code, page.defaultPage)
                                .then(function(pageInfoFields) {
                ...
                this.displayConditionSelected = function(displayConditionResult) {
                    ...
                    if (isPrimaryPage) {
                        ...
                        page.label = displayConditionResult.primaryPage
         ...
         */
        .controller('addPageWizardController', function(
            $q,
            wizardManager,
            pageBuilderFactory,
            lodash,
            ...
            var restrictionsStepHandler = restrictionsStepHandlerFactory.createRestrictionsStepHandler(
                wizardManager,
            ...
            this.pageBuilder = pageBuilderFactory.createPageBuilder(
            ...
            this.isFormValid = function(stepId) {
                switch (stepId) {
                    ...
                    case ADD_PAGE_WIZARD_STEPS.PAGE_INFO:
                        return (
                            self.callbacks.isDirtyPageInfo &&
                            self.callbacks.isDirtyPageInfo() &&
                            self.callbacks.isValidPageInfo &&
                            self.callbacks.isValidPageInfo()
                        );
            ...
            this.onDone = function() {
                return self.callbacks.savePageInfo().then(function(page) {
                    ...
                    return pageFacade.createPage(page).then(
                        ...
                        function(failure) {
                            ...
                            if (
                                !failure.error.errors.find(function(error) {
            ...
            this.isRestrictionsActive = function isRestrictionsActive() {
                if (
                    !self.typeChanged ||
                    wizardManager.getCurrentStepId() === ADD_PAGE_WIZARD_STEPS.PAGE_RESTRICTIONS
                ) {
            ...
            this.isPageInfoActive = function isPageInfoActive() {
                if (
                    !self.infoChanged ||
                    wizardManager.getCurrentStepId() === ADD_PAGE_WIZARD_STEPS.PAGE_INFO
                ) {
