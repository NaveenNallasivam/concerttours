 ...
 */
angular
    .module('selectPageTypeModule', ['pageTypeServiceModule', 'cmsSmarteditServicesModule'])
    ...
    .controller('selectPageTypeController', [
        ...
        function(pageTypeService, typePermissionsRestService) {
            this.pageTypes = [];
            ...
            this.$onInit = function $onInit() {
                pageTypeService.getPageTypes().then(
                    function(pageTypes) {
                        var allPageTypeCodes = pageTypes.map(function(pageType) {
                            return pageType.code;
                        });
                        typePermissionsRestService
                            .hasCreatePermissionForTypes(allPageTypeCodes)
                            .then(
