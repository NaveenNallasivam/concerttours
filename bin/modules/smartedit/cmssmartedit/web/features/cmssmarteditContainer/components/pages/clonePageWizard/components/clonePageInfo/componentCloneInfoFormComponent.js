 ...
 */
angular
    .module('componentCloneInfoFormModule', [
        'yLoDashModule',
        'pageFacadeModule',
        'pageServiceModule',
        'genericEditorModule',
    ...
    .controller('componentCloneInfoFormController', function(
        $translate,
        lodash,
        catalogService,
        languageService,
            ...
            this.setGenericEditorApi = function(api) {
                ...
                if (
                    ...
                    this.pageInfoEditorApi.getLanguages = function() {
                        return languageService.getLanguagesForSite(
                            this.targetCatalogVersion.siteId
                        );
                    }.bind(this);
                }
