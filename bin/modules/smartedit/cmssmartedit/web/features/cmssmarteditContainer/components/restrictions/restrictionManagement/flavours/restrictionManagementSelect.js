 ...
 **/
angular
    .module('restrictionManagementSelectModule', [
    ...
    .controller('RestrictionManagementSelectController', function(
        ...
        var RESTRICTION_CREATE_BUTTON_PRESSED_EVENT_ID =
            'RESTRICTION_CREATE_BUTTON_PRESSED_EVENT_ID';
        var createButtonUnSubscribeFn;

        this.resultsHeaderTemplate =
        ...
        this.selectRestriction = function selectRestriction() {
            if (this.selectModel.restrictionSelected()) {
                ...
                this.controllerModel.structureApi = restrictionsService.getStructureApiUri(
                    this.controllerModel.mode
                );
        ...
        this.createRestriction = function createRestriction(name) {
            this.selectModel.createRestrictionSelected(name, this.uriContext).then(
                function() {
        ...
        this.$onInit = function $onInit() {
            this.selectModel = restrictionManagementSelectModel.createRestrictionManagementSelectModel(
                this.getRestrictionTypesFn,
                this.getSupportedRestrictionTypesFn
            );
            ...
            this.submitFn = function() {
                if (this.selectModel.isTypeSupported()) {
                    return this.submitInternal().then(
                        function(value) {
                            return value;
                        }.bind(this)
                    );
            ...
            createButtonUnSubscribeFn = systemEventService.subscribe(
                RESTRICTION_CREATE_BUTTON_PRESSED_EVENT_ID,
    ...
    .factory('restrictionManagementSelectModel', function(
        ...
        function RestrictionManagementSelectModel(
            ...
            getRestrictionTypesFn().then(
                function(restrictionTypesResponse) {
            ...
            this.getRestrictionsPaged = function(mask, pageSize, currentPage) {
                ...
                return cmsitemsRestService.get(requestParams).then(
                    function(pagedRestrictionsResult) {
                        restrictions = pagedRestrictionsResult.response;
                        var ctr = 0;
                        pagedRestrictionsResult.response.forEach(
            ...
            this.restrictionSelected = function() {
                if (this.selectedIds.restriction || this.selectedIds.restriction === 0) {
                    selectedRestriction = restrictions.find(
                        function(restriction) {
            ...
            this.restrictionTypeSelected = function() {
                ...
                model.selectedRestrictionType = model.restrictionTypes
                    ? model.restrictionTypes.find(
            ...
            this.createRestrictionSelected = function(name, uriContext) {
                ...
                return catalogService
                    .getCatalogVersionUUid(uriContext)
            ...
            this.isTypeSupported = function() {
                if (model.selectedRestrictionType && model.selectedRestrictionType.code) {
                    return (
                        supportedRestrictionTypes.indexOf(model.selectedRestrictionType.code) >= 0
                    );
                }
                return false;
            };
        ...
        return {
            createRestrictionManagementSelectModel: function(
                getRestrictionTypesFn,
                getSupportedRestrictionTypesFn
            ) {
                return new RestrictionManagementSelectModel(
                    getRestrictionTypesFn,
                    getSupportedRestrictionTypesFn
                );
            }
