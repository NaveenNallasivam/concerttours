 ...
 */
angular
    .module('newPageDisplayConditionModule', ['pageServiceModule'])
    ...
    .controller('newPageDisplayConditionController', function(
        ...
        this.$onInit = function() {
            ...
            this.initialConditionSelected =
                this.initialConditionSelected || 'page.displaycondition.primary';
        ...
        this.$onChanges = function $onChanges(changes) {
            if (
                (changes.pageTypeCode && this.pageTypeCode !== this.previousPageTypeCode) ||
                (changes.targetCatalogVersion &&
                    this.targetCatalogVersion !== this.previousTargetCatalogVersion)
            ) {
                ...
                if (
                    ...
                    this._isUriContextEqualToCatalogVersion(
                        this.uriContext,
                        this.targetCatalogVersion
                    )
                ) {
        ...
        this._isPrimaryContentPage = function() {
            return (
                ...
                this.conditionSelected.isPrimary === true &&
        ...
        this._getPrimaryPages = function _getPrimaryPages() {
            if (this.pageTypeCode) {
                if (cache[this.pageTypeCode]) {
                    ...
                    pageService
                        .getPrimaryPagesForPageType(this.pageTypeCode, this.uriContext)
                        .then(
        ...
        this._getAllPrimaryDisplayCondition = function() {
            pageDisplayConditionsService
                .getNewPageConditions(this.pageTypeCode, this.uriContext)
                .then(
                    function(response) {
                        ...
                        if (this.conditions.length > 1) {
                            this.conditionSelected = lodash.find(
                                this.conditions,
                                function(condition) {
                        ...
                        if (this.primaryPageChoices && this.primaryPageChoices.length > 0) {
                            if (this.initialPrimaryPageSelected) {
                                this.primarySelected = this.primaryPageChoices.find(
                                    function(page) {
