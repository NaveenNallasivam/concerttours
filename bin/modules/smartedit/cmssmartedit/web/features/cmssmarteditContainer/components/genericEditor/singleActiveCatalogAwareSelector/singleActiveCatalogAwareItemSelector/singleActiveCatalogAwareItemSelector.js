 ...
 */
angular
    .module('singleActiveCatalogAwareItemSelectorModule', [
    ...
    .controller('SingleActiveCatalogAwareItemSelectorController', function(
        catalogService,
        CONTEXT_SITE_ID,
        SINGLE_CATALOG_AWARE_ITEM_MAPPING
    ) {
        ...
        */
        var initProductCatalogs = function() {
            catalogService.getProductCatalogsForSite(CONTEXT_SITE_ID).then(
                function(catalogs) {
