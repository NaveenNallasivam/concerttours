 ...
 */
angular
    .module('itemSelectorPanelModule', ['sliderPanelModule', 'l10nModule', 'recompileDomModule'])
    .controller('ItemSelectorPanelController', function($q, $element, lodash) {
        ...
        this.$onInit = function() {
            ...
            this.showPanel = function() {
                this.catalogInfo = {};
                this._initCatalogs();
                this._internalItemsSelected = this.itemsSelected
                    ? lodash.clone(this.itemsSelected)
                    : [];
        ...
        this._initItemsSelector = function() {
            var callWithCatalogInfo = function(fn, filterArguments) {
                ...
                return fn.apply(null, newArgs).then(
                    function(page) {
                        if (filterArguments) {
            ...
            this._internalItemsFetchStrategy = {
                fetchAll: this.itemsFetchStrategy.fetchAll
                    ? callWithCatalogInfo.bind(null, this.itemsFetchStrategy.fetchAll, false)
                    : null,
                fetchPage: this.itemsFetchStrategy.fetchPage
                    ? callWithCatalogInfo.bind(null, this.itemsFetchStrategy.fetchPage, true)
                    : null,
        ...
        this._saveItemChanges = function() {
            ...
            this.itemsSelected.splice.apply(
                this.itemsSelected,
                [0, this.itemsSelected.length].concat(this._internalItemsSelected)
            );
