...
import { HeaderLanguageDropdownComponent, SeGenericEditorModule } from 'smarteditcommons';
...
@NgModule({
    ...
    imports: [PopoverModule, CommonModule, SeGenericEditorModule, TranslateModule.forChild()],
    declarations: [
