...
export class ExperienceSelectorComponent {
    ...
    async preparePayload(experienceContent: IExperienceContent): Promise<IPreviewData> {
        ...
        ] = experienceContent.previewCatalog.split('_');
    ...
    private async resetExperienceSelectorFn(): Promise<void> {
        ...
        this.content = {
            ...
            previewCatalog: `${experience.siteDescriptor.uid}_${experience.catalogDescriptor.catalogId}_${experience.catalogDescriptor.catalogVersion}`
