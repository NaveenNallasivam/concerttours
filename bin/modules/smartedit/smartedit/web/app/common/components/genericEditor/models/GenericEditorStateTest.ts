...
describe('GenericEditor - GenericEditorState', () => {
    ...
    it('method sanitizedPayload will remove dangerous characters from a localized ShortString component', () => {
        const fields: GenericEditorField[] = [
            {
                qualifier: 'urlLink',
                cmsStructureType: 'ShortString',
    ...
    it('method sanitizedPayload will remove dangerous characters from a LongString component', () => {
        const fields: GenericEditorField[] = [
            {
                qualifier: 'urlLink',
                cmsStructureType: 'ShortString'
