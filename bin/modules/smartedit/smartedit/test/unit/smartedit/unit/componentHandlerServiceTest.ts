...
describe('componentHandlerService - inner', () => {
    ...
    describe('getFirstSmartEditComponentChildren', () => {
        ...
        const DEEP_LEVEL_CHILD_PATH =
            'body > main > .smartEditComponent > div > ul > .smartEditComponent';
        const DEEP_LEVEL_NESTED_CHILD_PATH =
            'body > main > .smartEditComponent > div > .smartEditComponent > ul > .smartEditComponent';
