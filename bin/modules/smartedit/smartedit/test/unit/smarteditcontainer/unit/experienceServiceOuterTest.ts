...
describe('experienceService', () => {
    ...
    it('WHEN updateExperiencePageID is called THEN it retrieves the current experience, changes it and re-initializes the catalog', async (done) => {
        // Arrange
    ...
    it('GIVEN that an experience has been set WHEN I request to load a storefront THEN initializeExperience will call updateExperience', async (done) => {
        // Arrange
    ...
    it('GIVEN that no experience has been set THEN initializeExperience will redirect to landing page', async (done) => {
        // Arrange
    ...
    it('WHEN updateExperience is called THEN it retrieves the current experience, merges it with the new experience, creates a preview ticket and reloads the iFrame', async (done) => {
        const newExperience = {
