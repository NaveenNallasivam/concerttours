...
public class RetentionCleanupJobPerformableTest extends ServicelayerBaseTest
{
	...
	private final PropertyConfigSwitcher auditOrderconfigSwitcher = new PropertyConfigSwitcher("audit.order.enabled");
	private final PropertyConfigSwitcher auditGlobalconfigSwitcher = new PropertyConfigSwitcher("auditing.enabled");
	...
	{
		auditOrderconfigSwitcher.switchBackToDefault();
		auditGlobalconfigSwitcher.switchBackToDefault();
	}
	...
	@Test
	public void testSimpleRemoveJobStrategyWithBatchSizeOneHundredNoAudit() throws Exception
	{
		auditOrderconfigSwitcher.switchToValue("false");
		auditGlobalconfigSwitcher.switchToValue("false");
		auditingEnablementService.refreshConfiguredAuditTypes();
